...
export default function AnalyticsDashboard() {
    return (
        <div className='grid grid-cols-1 xl:grid-cols-5 2xl:grid-cols-6 gap-x-4 gap-y-4'>
            ...
            <div className='analytics-dashboard-card col-span-1 xl:col-span-2 overflow-x-hidden h-[550px] xl:h-[600px]'>
            ...
            <div className='analytics-dashboard-card col-span-1 xl:col-span-3 2xl:col-span-4 h-[475px] sm:h-[600px]'>
